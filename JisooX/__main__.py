...
PM_START_TEXT = """
_ʜᴀʟᴏ_ *{}*
_ɴᴀᴍᴀ ɢᴜᴀ_ * {} * \ n_ᴀ ᴘʀᴏʙᴏᴛ ᴛᴇʟᴇɢʀᴀᴍ ʏᴀɴɢ ᴋᴜᴀᴛ ᴜɴᴛᴜᴋ ᴍᴇɴɢᴇʟᴏʟᴀ ɢʀᴜᴘ ᴀɴᴅᴀ ᴅᴀɴ ᴜɴᴛᴜᴋ ᴍᴇɴʏᴀʟᴀᴋᴀɴ ʟᴀɢᴜ ᴅɪ ᴠᴄɢ ᴊᴀɴɢᴀɴ ʀᴀɢᴜ ᴜɴᴛᴜᴋ ᴍᴇɴᴀᴍʙᴀʜ ᴋᴇ ɢʀᴜᴘ ᴀɴᴅᴀ !! _
_ᴍᴀɪɴᴛᴇɴᴇᴅ ʙʏ_ [{}](tg: // user? id = {})
""
"""
...
HELP_STRINGS = """
ʜᴀʟᴏ ɢᴜᴀ *{}*
ʙᴏᴛ ɪɴɪ ᴜɴᴛᴜᴋ ᴍᴀɴᴀɢᴇʀ ɢʀᴜᴘ ᴅᴀɴ ᴍᴜsɪᴋ ʏᴀ, ɢᴀʙᴜᴛ ᴅᴏᴀɴɢ ɢᴜᴀ. ᴊᴀᴅɪ ʙᴜᴀᴛ ɢɪɴɪᴀɴ (https://telegra.ph/file/3a622f66018a4f603762d.jpg)
...
SOURCE_STRING = """
⚡ɪ'ᴍ ʙᴜɪʟᴛ ɪɴ ᴘʏᴛʜᴏɴ3, ᴜsɪɴɢ ᴛʜᴇ ᴘʏᴛʜᴏɴ-ᴛᴇʟᴇɢʀᴀᴍ-ʙᴏᴛ ʟɪʙʀᴀʀʏ, ᴀɴᴅ ᴀᴍ ꜰᴜʟʟʏ ᴏᴘᴇɴsᴏᴜʀᴄᴇ - ʏᴏᴜ ᴄᴀɴ ꜰɪɴᴅ ᴡʜᴀᴛ ᴍᴀᴋᴇs ᴍᴇ ᴛɪᴄᴋ [here](https://github.com/jjorvax/vaxzrobot)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/jjorvax/vaxzrobot.git)
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="[► ʜᴇʟᴘ ◄]",callback_data="help_back"),InlineKeyboardButton(text="[► ᴄʀᴇᴀᴛᴏʀ ◄]",url="https://t.me/jjorvaxeskopeace")]]
    keyboard += [[InlineKeyboardButton(text="[► ɢʀᴏᴜᴘ ◄]",url="https://t.me/FamilyRuthless"),InlineKeyboardButton(text="[► ᴀᴅᴅ ᴍᴇ ◄]",url="t.me/{}?startgroup=true".format(bot.username))]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="[► ᴄʀᴇᴀᴛᴏʀ ◄]",url="https://t.me/jjorvaxeskopeace")]]))
        return
